...
function reconfigureLimits2(userConfig) {
  ...
  spanLimits.attributeCountLimit = ((_a2 = userConfig.spanLimits) == null ? void 0 : _a2.attributeCountLimit) ?? ((_b = userConfig.generalLimits) == null ? void 0 : _b.attributeCountLimit) ?? getNumberFromEnv2("OTEL_SPAN_ATTRIBUTE_COUNT_LIMIT") ?? getNumberFromEnv2("OTEL_ATTRIBUTE_COUNT_LIMIT") ?? DEFAULT_ATTRIBUTE_COUNT_LIMIT;
  spanLimits.attributeValueLengthLimit = ((_c = userConfig.spanLimits) == null ? void 0 : _c.attributeValueLengthLimit) ?? ((_d = userConfig.generalLimits) == null ? void 0 : _d.attributeValueLengthLimit) ?? getNumberFromEnv2("OTEL_SPAN_ATTRIBUTE_VALUE_LENGTH_LIMIT") ?? getNumberFromEnv2("OTEL_ATTRIBUTE_VALUE_LENGTH_LIMIT") ?? DEFAULT_ATTRIBUTE_VALUE_LENGTH_LIMIT;
...
var BatchSpanProcessorBase2 = class {
  constructor(_exporter, config) {
    ...
    this._maxExportBatchSize = typeof (config == null ? void 0 : config.maxExportBatchSize) === "number" ? config.maxExportBatchSize : getNumberFromEnv2("OTEL_BSP_MAX_EXPORT_BATCH_SIZE") ?? 512;
    this._maxQueueSize = typeof (config == null ? void 0 : config.maxQueueSize) === "number" ? config.maxQueueSize : getNumberFromEnv2("OTEL_BSP_MAX_QUEUE_SIZE") ?? 2048;
    this._scheduledDelayMillis = typeof (config == null ? void 0 : config.scheduledDelayMillis) === "number" ? config.scheduledDelayMillis : getNumberFromEnv2("OTEL_BSP_SCHEDULE_DELAY") ?? 5e3;
    this._exportTimeoutMillis = typeof (config == null ? void 0 : config.exportTimeoutMillis) === "number" ? config.exportTimeoutMillis : getNumberFromEnv2("OTEL_BSP_EXPORT_TIMEOUT") ?? 3e4;
